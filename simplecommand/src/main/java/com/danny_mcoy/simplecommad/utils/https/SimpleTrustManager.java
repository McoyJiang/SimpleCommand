...
/**
 * Implementation of {@author Nikolay Elenkov} trust manager with local and new trust store
 * {@see https://github.com/nelenkov/custom-cert-https}
 *
 * Created by Danny_姜新星
 */
public class SimpleTrustManager implements X509TrustManager, Serializable {

    private static final String TAG = SimpleTrustManager.class.getSimpleName();
    private static KeyStore localKeyStore = null;

    public static KeyStore getLocalKeyStore() {
    ...
    public SimpleTrustManager(KeyStore localKeyStore) {
